...
protocol SelectRoomTypeTVCDelegate: class {
...
class SelectRoomTypeTVC: UITableViewController {
    ...
    var roomType: Room?
    weak var delegate: SelectRoomTypeTVCDelegate?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let roomType = Room.all[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        roomType = Room.all[indexPath.row]
        delegate?.didSelect(room: roomType!)
